...
if (isset($_SESSION['role']) && isset($_SESSION['id']) ) {
    ...
    include "app/Model/User.php"; // यह 'count_unread_notifications' फंक्शन लाएगा
    ...
    if ($_SESSION['role'] == "admin") {
        ...
        // --- ⬇️ (बदलाव 1) 'unread' गिनती को यहाँ कॉल करें ---
        $unread_notifications = count_unread_notifications($conn, $_SESSION['id']);

    }else {
        // (यह एम्प्लॉई के लिए है)
        ...
        // --- ⬇️ (बदलाव 2) 'unread' गिनती को यहाँ भी कॉल करें ---
        $unread_notifications = count_unread_notifications($conn, $_SESSION['id']);
    }
 ?>
<!DOCTYPE html>
            ...
            <?php if ($_SESSION['role'] == "admin") { ?>
                <div class="dashboard">
                    ...
                    <div class="dashboard-item">
                        ...
                        <span><?=$unread_notifications?> Notifications</span>
                    </div>
